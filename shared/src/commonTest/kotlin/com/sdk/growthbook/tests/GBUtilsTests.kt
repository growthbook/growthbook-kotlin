...
class GBUtilsTests {
    ...
    @Test
    fun testHash(){
        val evalConditions = TestData.getFNVHashData()
    ...
    @Test
    fun testBucketRange(){
        val evalConditions = TestData.getBucketRangeData()
        var failedScenarios : ArrayList<String> = ArrayList()
        var passedScenarios : ArrayList<String> = ArrayList()
        for (item in evalConditions) {
            if (item is JsonArray) {
    ...
    fun testChooseVariation(){
        val evalConditions = TestData.getChooseVariationData()
        var failedScenarios : ArrayList<String> = ArrayList()
        var passedScenarios : ArrayList<String> = ArrayList()
        for (item in evalConditions) {
            if (item is JsonArray) {
    ...
    @Test
    fun testInNameSpace(){
        val evalConditions = TestData.getInNameSpaceData()
        var failedScenarios : ArrayList<String> = ArrayList()
        var passedScenarios : ArrayList<String> = ArrayList()
        for (item in evalConditions) {
            if (item is JsonArray) {
    ...
    fun testEqualWeights(){
        val evalConditions = TestData.getEqualWeightsData()
        var failedScenarios : ArrayList<String> = ArrayList()
        var passedScenarios : ArrayList<String> = ArrayList()
        for (item in evalConditions) {
            if (item is JsonArray) {
